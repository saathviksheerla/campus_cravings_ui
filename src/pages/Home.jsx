      ...
      <div className="max-w-7xl mx-auto lg:px-8">
        <div className="relative pt-22 pb-18">
          <div className="text-center">
            <h1 className="font-display text-display-lg md:text-display-xl font-bold text-secondary">
              <span className="block">Delicious food at your</span>
              <span className="block text-accent mt-4">college campus</span>
            </h1>
            <p className="mt-8 text-xl font-body text-secondary-light/80 max-w-2xl mx-auto">
              Order fresh, tasty meals from your college canteen. Skip the lines and get notified when your food is ready.
            </p>
            <div className="mt-12 flex justify-center gap-6">
              <Link
                to="/menu"
                className="px-8 py-3 bg-accent text-primary font-body font-medium rounded-md hover:bg-accent-dark transition-colors"
              >
                View Menu
              </Link>
              {!user && (
